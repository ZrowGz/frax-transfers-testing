...
// contract MockFraxSwapLPOracle {
// /// @dev Mocks testing price returns
...
//             uint256
//         ) {
//             // value obtained from oracle 09/30/2022 for
//             return (998662510000000000, 998662, 749926075128085);
//         }
// }
...
/// @notice Minimalistic INonfungiblePositionManager
interface IMinimalNftManager {
...
interface INftManager is IERC721Metadata, IERC721Enumerable, IMinimalNftManager {
...
contract ComboOracle_UniV2_UniV3 {
    // is Owned {
    ...
    // INftManager public univ3_positions;
    IUniswapV3Factory public univ3_factory = IUniswapV3Factory(0x1F98431c8aD98523631AE4a59f267346ea31F984);
    INftManager public univ3_positions = INftManager(0xC36442b4a4522E871399CD717aBDD847Ab11FE88);
    ...
    constructor() {
        ...
        univ3_positions = INftManager(0xC36442b4a4522E871399CD717aBDD847Ab11FE88);
    ...
    function getUniV3NFTValueInfo(uint256 token_id) public view returns (UniV3NFTValueInfo memory) {
        ...
        uint256 valToReturn = (uint256(lp_basic_info.liquidity) * PRECISE_PRICE_PRECISION) / nft_ttl_val;
    ...
    //     univ3_positions = INftManager(_positions_nft_manager);
...
interface IComboOracle {
    ...
    function getTokenPrice(address token_address)
        external
        view
        returns (
...
contract ComboOracle {
    //is Owned { /// TODO This could be modified to return mock values, rather than relying on hardcoding in the values in the logic above.
    ...
    AggregatorV3Interface private priceFeedETHUSD =
        AggregatorV3Interface(address(0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419));
    ...
    // Price mappings
    uint256 public maxDelayTime = 90000; // 25 hrs. Mapping for max delay time
