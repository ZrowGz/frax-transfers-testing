...
// Uniswap V2 / Fraxswap
import "@frax_testing/gauges/Uniswap/Interfaces/IFraxswapPair.sol";
...
contract FraxFarmERC20 is FraxUnifiedFarmTemplate {
    /* ========== STATE VARIABLES ========== */
    ...
    function lockAdditional(bytes32 kek_id, uint256 addl_liq)
        public
        nonReentrant
